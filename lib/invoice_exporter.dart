...
class InvoiceExporter {
  ...
  Future<void> exportInvoiceToPdf(BuildContext context, int orderId) async {
    try {
      ...
      final baseTheme = pw.ThemeData.base();
        ...
        pw.MultiPage(
          ...
          build: (pw.Context context) {
            return [
              ...
              pw.Row(
                ...
                children: [
                  pw.Column(
                    ...
                    children: [
                      pw.Text('Tên cửa hàng: Coffee Shop ', style: pw.TextStyle(font: _vietnameseFontBold)),
                  ...
                  pw.Column(
                    crossAxisAlignment: pw.CrossAxisAlignment.start,
                    children: [
                      pw.Text('Mã hóa đơn: #${order.mahd ?? 'N/A'}', style: pw.TextStyle(font: _vietnameseFontBold)),
              ...
              pw.Text('Thông tin khách hàng:', style: pw.TextStyle(font: _vietnameseFontBold)),
              ...
              pw.Table.fromTextArray(
                ...
                headerStyle: pw.TextStyle(font: _vietnameseFontBold),
              ...
              pw.Align(
                ...
                child: pw.Column(
                  ...
                  children: [
                    pw.Text('Tổng tiền món ăn: ${currencyFormat.format(tongTienGoc)}đ',
                        style: pw.TextStyle(font: _vietnameseFontRegular)),
                    if (giamGia > 0)
                      pw.Text('Giảm giá: -${currencyFormat.format(giamGia)}đ',
                          style: pw.TextStyle(font: _vietnameseFontRegular, color: PdfColors.red)),
                    
                    pw.Divider(),
                    pw.Text(
                      'Thành tiền: ${currencyFormat.format(order.tongtien)}đ',
                      style: pw.TextStyle(fontSize: 18, font: _vietnameseFontBold, fontWeight: pw.FontWeight.bold, color: PdfColors.red),
                    ),
              ...
              pw.Text('Cảm ơn quý khách đã sử dụng dịch vụ của chúng tôi!',
                  style: pw.TextStyle(font: _vietnameseFontRegular, fontStyle: pw.FontStyle.italic)),
            ];
          },
        ),
      );
